...
<?php
    if(is_array($listonesp)){
        extract($listonesp);
		$hinh = "../../../public/upload/".$listonesp['img'];
    }
?>
<section class="main-content-section">
		<div class="container">
			...
			<div class="bstore-breadcrumb">
				...
				<span><?php echo $ten_sanpham ?></span>
			</div>
			...
			<div class="row">
						...
						<div class="col-lg-7 col-md-8">
							<div class="single-product-descirption">
								...
								<div class="single-product-price">
									<h2><?php echo $gia ?> VNĐ</h2>
								</div>
								<div class="single-product-desc">
									<p><?php echo $moTa ?></p>
									<div class="product-in-stock">
										<p><?php echo $soLuong ?> Sản phẩm<span><?php echo $trangThai ?></span></p>
									</div>
								</div>
								...
								<div class="single-product-quantity">
									...
									<div class="cart-quantity">
										<div class="">
											<input class="cart-plus-minus sing-pro-qty" max="<?php echo $soLuong ?>" min=0 type="number" name="qtybutton"
												value="0">
										</div>
									</div>
								</div>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="moreinfo">
								<div class="tab-description">
									<p>Được thừa hưởng thiết kế của iPhone 12 Pro Max với khung viền vuông vức bằng thép, mặt lưng kính cùng màn hình tai thỏ đặc trưng. Phần tai thỏ của iPhone 13 Pro Max được thu gọn lại 20% so với thế hệ trước giúp giải phóng nhiều không gian hơn để hiển thị và làm mặt trước điện thoại trở nên cuốn hút hơn.</p>
								</div>
							</div>
								...
								<div class="deta-sheet">
									<table class="table-data-sheet">
										<tbody>
											<tr class="odd">
												<td>Dung lượng</td>
												<td><?php echo $dungLuong ?></td>
											</tr>
											<tr class="even">
												<td class="td-bg">Màu sắc</td>
												<td class="td-bg"><?php echo $mauSac ?></td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="related-product owl-carousel">
								...
								<?php
									foreach ($listspcl as $sp){
										$anh="../../../public/upload/".$listonesp['img'];
										echo '<div class="single-product-item">
										<div class="product-image">
											<a href="index.php?act=sanphamchitiet&id='.$sp['id_sanpham'].'&id_dm='.$sp['id_dm'].'"><img src="'.$anh.'"
													alt="product-image" /></a>
										</div>
										<div class="product-info">
											...
											<a href="index.php?act=sanphamchitiet?id='.$sp['id_sanpham'].'&id_dm='.$sp['id_dm'].'">'.$sp['ten_sanpham'].'</a>
											<div class="price-box">
								...
								<div class="single-product-item">
									<div class="product-image">
										<a href="#"><img src="../../../public/assets/images/product/sale/5.webp"
												alt="product-image" /></a>
				...
				<div class="col-lg-3">
					...
					<div class="single-product-right-sidebar">
						...
						<ul>
							<li>
								<a href="#"><img src="../../../public/assets/images/product/sidebar_product/2.webp" alt="" /></a>
							...
							<li>
								<a href="#"><img src="../../../public/assets/images/product/sidebar_product/4.webp" alt="" /></a>
								<div class="r-sidebar-pro-content">
							...
							<li>
								<a href="#"><img src="../../../public/assets/images/product/sidebar_product/6.webp" alt="" /></a>
								<div class="r-sidebar-pro-content">
							...
							<li>
								<a href="#"><img src="../../../public/assets/images/product/sidebar_product/1.webp" alt="" /></a>
								<div class="r-sidebar-pro-content">
					...
					<div class="single-product-right-sidebar">
						<div class="slider-right zoom-img">
							<a href="#"><img class="img-responsive" src="../../../public/assets/images/product/cms11.webp"
									alt="sidebar left" /></a>
						</div>
					</div>
				</div>
